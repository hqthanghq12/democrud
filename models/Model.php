...
class  Model{
    ...
    private $host = HOST; // Địa chỉ IP của máy chủ CSDL
    private $dbname = DBNAME; // Tên CSDL
    private $username = USERNAME; // Tên đăng nhập mysql
    private $password = PASSWORD; // Mật khẩu đăng nhập mysql
    // Xử lý
